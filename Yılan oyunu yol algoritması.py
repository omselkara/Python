...
meyve = canvas.create_rectangle(sütun,satır,sütun+70,satır+70,fill="red")
pencere.bind("<Key>", lambda a : keya(a.char))
yazı = canvas.create_text(37,15, text="Skor:{}".format(skor),font=("italic", 18),fill="blue")
while 1:
    canvas.update()
    if xkafa == 2 and ykafa == 632:
        keya("w")
    elif xkafa == 2 and ykafa == 2:
        keya("d")
    elif xkafa == 1192 and ykafa == 2:
        keya("s")
    elif xkafa == 1192 and ykafa == 72:
        keya("a")
    elif xkafa == 72 and ykafa == 72:
        keya("s")
    elif xkafa == 72 and ykafa == 142:
        keya("d")
    elif xkafa == 1192 and ykafa == 142:
        keya("s")
    elif xkafa == 1192 and ykafa == 212:
        keya("a")
    elif xkafa == 72 and ykafa == 212:
        keya("s")
    elif xkafa == 72 and ykafa == 282:
        keya("d")
    elif xkafa == 1192 and ykafa == 282:
        keya("s")
    elif xkafa == 1192 and ykafa == 352:
        keya("a")
    elif xkafa == 72 and ykafa == 352:
        keya("s")
    elif xkafa == 72 and ykafa == 422:
        keya("d")
    elif xkafa == 1192 and ykafa == 422:
        keya("s")
    elif xkafa == 1192 and ykafa == 492:
        keya("a")
    elif xkafa == 72 and ykafa == 492:
        keya("s")
    elif xkafa == 72 and ykafa == 562:
        keya("d")
    elif xkafa == 1192 and ykafa == 562:
        keya("s")
    elif xkafa == 1192 and ykafa == 632:
        keya("a")
    hareket()
